...
public class Main {
    ...
    private static void exercise1() {
        ...
        System.out.println(ourNumberInt + 2);
    }
    ...
    private static void exercise2() {
        ...
        //the 'charAt()' method takes the char in the position indicated inside the brackets and, in this case, prints only that
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "7.6"; // Also this line
    ...
    private static void exercise4() {
        ...
        int startStrNumber = Integer.valueOf(startStr);
        startStrNumber *= 2;
        String newString = String.valueOf(startStrNumber);
        newString += newString;
        double newStringDouble = Double.valueOf(newString);
        newStringDouble /= 3.5;
        System.out.println(Math.floor(newStringDouble));
